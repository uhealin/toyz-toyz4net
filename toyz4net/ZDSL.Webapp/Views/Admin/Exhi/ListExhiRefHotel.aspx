...
<%  
    ...
    string exhiId = WebUtil.GetParamAttr("exhiId","");    
 %>
...
<script  type="text/javascript">
    ...
    opts["id"] = "id";
    opts["urlUpdate"] = "<%=basePath %>/Admin/Exhi/SaveExhiRefHotel?exhiId=<%=exhiId %>";
    opts["urlAdd"] = opts["urlUpdate"];
    opts["urlRemove"] = "<%=basePath %>/Admin/Exhi/RemoveExhiRefHotel?exhiId=<%=exhiId %>";
    ...
    url: "<%=basePath %>/Admin/Exhi/DatagridExhiRefHotel?exhiId=<%=exhiId %>",
        idField: "id"
                  , pagination: false
             , columns: [
