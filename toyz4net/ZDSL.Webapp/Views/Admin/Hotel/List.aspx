...
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
       <% string basePath = Toyz4net.Core.Util.WebUtil.GetWebRootPath();
          ...
          string pathDatagrid = string.Format("{0}/Admin/Hotel/Datagrid_{1}_{2}", basePath, status, isreserve);
      ...
      <script type="text/javascript">
          ...
          var colHotelId = { title: "", field: "hotelId", width: 100 };
          ...
          var colMonthBookedCount = { title: "月预订数", field: "monthBookedCount", width: 60, editor: {type:"numberspinner"} };
           var colWeekBookedCount = { title: "周预订数", field: "weekBookedCount", width: 60, editor: {type:"numberspinner"} };
          ...
          var editors = [colHotelName, colHotelNameEn, colRecInd,colRecLevel, colIsreserve,colWeekBookedCount,colMonthBookedCount,colGoodCommentCount,colBadCommentCount];
          ...
          $(document).ready(function() {
             ...
             ,idField:"hotelId"
          , columns: [
               [colCb, colHotelId, colHotelName, colIsreserve, colRecInd, colRecLevel,colWeekBookedCount,colMonthBookedCount,colGoodCommentCount,colBadCommentCount]
            ]
          , toolbar: toolbar
