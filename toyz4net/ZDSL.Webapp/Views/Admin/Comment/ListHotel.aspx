...
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
 ...
 <% string basePath = Toyz4net.Core.Util.WebUtil.GetWebRootPath();
          ...
          string pathDatagrid = string.Format("{0}/Admin/Comment/DatagridHotel_{1}", basePath, status);
      ...
      <script type="text/javascript">
          ...
          var colHotelFk = { title: "酒店号", field: "hotelFk", width: 200 };
          var colServiceFk = { title: "服务评级", field: "serviceLevel", width: 200 };
         
          var status = { title: "状态", field: "status", width: 100 };

          var editors = [colTitle, colCreateDate, colContext];
          
          var opts = {};
          opts["regexp"] = "#tableDG";
          opts["id"] = "id";
          opts["urlUpdate"] = "<%=basePath %>/Admin/Comment/SaveHotel";
          opts["urlAdd"] = opts["urlUpdate"];
          opts["urlRemove"] = "<%=basePath %>/Admin/Comment/RemoveHotel";
          ...
          $(document).ready(function() {
             ...
             ,idField:"id"
          , columns: [
               [colId, colTitle, colContext, colHotelFk, colCreateDate]
            ]
          ,toolbar:toolbar
              });
