...
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
 ...
 <% string basePath = Toyz4net.Core.Util.WebUtil.GetWebRootPath();
          ...
          string pathDatagrid = string.Format("{0}/Admin/Comment/DatagridOrder_{1}", basePath, status);
      ...
      <script type="text/javascript">
          ...
          var colNewsFk = { title: "新闻代号", field: "newsFk", width: 200 };
          ...
          opts["regexp"] = "#tableDG";
          opts["id"] = "id";
          opts["urlUpdate"] = "<%=basePath %>/Admin/Comment/SaveNews";
          opts["urlAdd"] = opts["urlUpdate"];
          opts["urlRemove"] = "<%=basePath %>/Admin/Comment/RemoveNews";
          ...
          $(document).ready(function() {
             ...
             ,idField:"id"
          , columns: [
               [colId, colTitle, colContext, colNewsFk, colCreateDate]
            ]
          ,toolbar:toolbar
              });
