...
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
 ...
 <% string basePath = Toyz4net.Core.Util.WebUtil.GetWebRootPath();
          ...
          string pathDatagrid = string.Format("{0}/Admin/Comment/DatagridExhi_{1}", basePath, status);
      ...
      <script type="text/javascript">
          ...
          var colExhiFk = { title: "展会号", field: "exhiFk", width: 200 };
          ...
          opts["regexp"] = "#tableDG";
          opts["id"] = "id";
          opts["urlUpdate"] = "<%=basePath %>/Admin/Comment/SaveExhi";
          opts["urlAdd"] = opts["urlUpdate"];
          opts["urlRemove"] = "<%=basePath %>/Admin/Comment/RemoveExhi";
          ...
          $(document).ready(function() {
             ...
             ,idField:"id"
          , columns: [
               [colId, colTitle, colContext, colExhiFk, colCreateDate]
            ]
          ,toolbar:toolbar
              });
